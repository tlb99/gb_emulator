...
6.  **Testing**: All new functionality must eventually include corresponding unit tests using the `Google Test` framework in the `tests/` directory.

## Project Context
*   **Purpose**: This repository contains a work-in-progress implementation of a Nintendo Game Boy emulator.
*   **Dependencies**: `Google Test`, `SDL2`, `spdlog`,
